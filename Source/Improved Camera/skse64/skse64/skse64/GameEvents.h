...
class EventDispatcher
{
	...
	DEFINE_MEMBER_FN(AddEventSink_Internal, void, 0x0056B7F0, SinkT * eventSink); // UDP: TODO
	// ??_7BGSProcedureShoutExecState@@6B@ dtor | +43
	DEFINE_MEMBER_FN(RemoveEventSink_Internal, void, 0x00423D60, SinkT * eventSink); // UDP: TODO
	// D6BA7CEC95B2C2B9C593A9AEE7F0ADFFB2C10E11+456
	DEFINE_MEMBER_FN_EX(SendEvent_Internal, void, 0x00177FB0, "40 55 56 57 41 54 41 55 41 56 41 57 - 48 83 EC 60 - 48 C7 44 24 40 FE FF FF FF -  48 89 9C 24 A8 00 00 00 - 4C 8B E2 - 4C 8B F1", EventArgT * evn); // Multiple signatures match this, but all of them are identical function
...
extern RelocAddr<_GetEventDispatcherList> GetEventDispatcherList; // UDP: TODO
