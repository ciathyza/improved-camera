...
public:
	...
	DEFINE_MEMBER_FN_EX(LockForRead, void, 0x00C074C0, "40 57 - 48 83 EC 20 - 48 8B F9 - FF 15 XXXXXXXX - 39 07 - 75 0A - F0 FF 47 04 - 48 83 C4 20 - 5F - C3 - 8B 47 04 25 - FF FF FF 0F");
	DEFINE_MEMBER_FN_EX(LockForWrite, void, 0x00C07540, "48 89 74 24 18 - 57 - 48 83 EC 20 - 48 8B F9 - FF 15 XXXXXXXX - 8B F0 - 39 07 - 75 0F");
	DEFINE_MEMBER_FN_EX(UnlockRead, void, 0x00C07780, "F0 FF 49 04 C3"); // Note: two matches, but both will accomplish same functionality
	DEFINE_MEMBER_FN_EX(UnlockWrite, void, 0x00C07790, "8B 41 04 - FF C8 - 3D 00 00 00 80 - 75 0B - 33 C0");
	DEFINE_MEMBER_FN_EX(LockForReadAndWrite, void, 0x00C07640, "48 89 74 24 18 - 57 - 48 83 EC 20 - 48 8B F9 - FF 15 XXXXXXXX - 8B F0 - 39 07 - 74 51");
	DEFINE_MEMBER_FN_EX(TryLockForWrite, bool, 0x00C07730, "40 53 - 48 83 EC 20 - 48 8B D9 - FF 15 XXXXXXXX - 8B C8 - 39 03 - 75 0C");
};
...
public:
	struct Ref
	{
		...
		DEFINE_MEMBER_FN_EX(ctor, Ref *, 0x00C28930, "40 53 - 48 83 EC 20 - 45 33 DB - 48 8B D9 - 4C 89 19", const char * buf);
		DEFINE_MEMBER_FN_EX(ctor_ref, Ref *, 0x00C289C0, "4C 8B 02 - 4C 8B C9 - 4D 85 C0 - 74 2D - 41 8B 40 F0", const Ref & rhs); // Note: two matches, but both function 100% identical
		DEFINE_MEMBER_FN_EX(Set, Ref *, 0x00C28AA0, "40 53 - 48 83 EC 20 - 48 8B 01 - 48 8B D9 - 48 89 44 24 38 - 48 85 D2", const char * buf);
		// 77D2390F6DC57138CF0E5266EB5BBB0ACABDFBE3+A0
		DEFINE_MEMBER_FN_EX_JUMP(Release, void, 0x00C28A80, "48 83 EC 38 - 48 C7 44 24 20 FE FF FF FF - 48 83 C4 38 - E9 XXXXXXXX", 0x12, "40 56 57 41 54 41 56 41 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 68 - 48 89 6C 24 70 - 4C 8B F9 - 48 8B 39 - 48 85 FF"); // Two matches, but they are equivalent
...
public:
	...
	DEFINE_MEMBER_FN_EX(Set, bool, 0x000FA080, "40 57 41 54 41 55 41 56 41 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 60 - 48 89 6C 24 68 - 48 89 74 24 70 - 41 8B F8 - 48 8B EA", const char * str, UInt32 len);	// len default 0
