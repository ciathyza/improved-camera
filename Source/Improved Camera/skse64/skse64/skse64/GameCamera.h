...
public:
	...
	DEFINE_MEMBER_FN_EX(SetCameraState, UInt32, 0x004F5E70, "48 89 5C 24 08 - 57 - 48 83 EC 20 - 48 8B F9 - 48 8B DA - 48 8B 49 28 - 48 85 C9 - 74 XX - 48 8B 01", TESCameraState * cameraState);
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(ctor, void, 0x001F5580, "48 89 4C 24 08 - 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 50 - 48 89 74 24 58 - 48 8B D9 - E8 XXXXXXXX - 90 - 48 8D 05 XXXXXXXX - 48 89 03 - F3 0F 10 05 XXXXXXXX");
	DEFINE_MEMBER_FN_EX(SetNorthRotation, void, 0x001F5940, "48 8B C4 - 53 - 48 81 EC C0 00 00 00 - 0F 28 05 XXXXXXXX", float northRotation);
};
...
public:
	...
	static PlayerCamera *	GetSingleton(void)
	{
		...
		static RelocPtrEx<PlayerCamera*> g_playerCamera(0x6A30DC, "48 8B 05 XXXXXXXX - F3 0F 10 35 XXXXXXXX - F3 0F 5C 80 54 01 00 00", 3, true); // 2EEC9B8
	...
	DEFINE_MEMBER_FN_EX(UpdateThirdPerson, void, 0x0084D820, "48 89 5C 24 08 - 57 - 48 83 EC 20 - 48 8B D9 - 0F B6 FA - 48 8B 0D XXXXXXXX - E8 XXXXXXXX", bool weaponDrawn);
};
