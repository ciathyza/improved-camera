...
extern RelocAddrEx <_LookupFormByID> LookupFormByID; // UDP: TODO
...
public:
	...
	DEFINE_MEMBER_FN_EX(AddFormToList, void, 0x002C55C0, "48 85 D2 - 0F 84 XXXX0000 48 89 54 24 10 - 57 - 48 83 EC 40 - 48 C7 44 24 20 FE FF FF FF", TESForm * form);
	DEFINE_MEMBER_FN_EX(RemoveFormFromList, void, 0x002C5760, "48 85 D2 - 0F 84 XXXX0000 - 53 - 48 83 EC 20 - 83 79 40 00", TESForm * form);
	DEFINE_MEMBER_FN_EX(RevertList, void, 0x002C54F0, "40 57 - 48 83 EC 40 - 48 C7 44 24 30 FE FF FF FF - 48 89 5C 24 50 - 48 89 74 24 58 - 48 8B D9 - 48 8B 79 38");
...
public:
	...
	DEFINE_MEMBER_FN_EX(ForceRefTo, UInt32, 0x00375240, "89 54 24 10 - 55 56 57 41 54 41 55 41 56 41 57 - 48 8B EC - 48 83 EC 70 - 48 C7 45 D8 FE FF FF FF - 48 89 9C 24 B0 00 00 00 - 4D 8B F0", UInt32 aliasId, TESObjectREFR * reference);
	DEFINE_MEMBER_FN(NewGame_Internal, UInt8, 0x00370B00, UInt8 * unk1, UInt8 unk2); // UDP: TODO
...
public:
	...
	DEFINE_MEMBER_FN(GetNorthRotation, double, 0x0026D700); // UDP: TODO
};
