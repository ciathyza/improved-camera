...
private:
	...
	DEFINE_MEMBER_FN_EX(CheckContainerExtraData_Internal, bool, 0x0010CE30, "40 56 57 41 56 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 58 - 48 89 6C 24 60 - 0F B6 EA - 48 8B F9 - 48 8D 59 10", bool isEquipped);
	// This also does some internal ReferenceHandle lookup
	DEFINE_MEMBER_FN_EX(GetExtraTextDisplayData_Internal, ExtraTextDisplayData*, 0x00111610, "40 53 55 56 57 - 48 83 EC 48 - 48 C7 44 24 20 FE FF FF FF - 48 8B E9 48 8D 59 10");
};
