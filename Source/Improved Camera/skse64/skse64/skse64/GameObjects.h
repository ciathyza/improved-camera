...
public:
	...
	DEFINE_MEMBER_FN(ctor, BSShaderTextureSet *, 0x012E06F0); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN(GetCostliestEffectItem, EffectItem *, 0x00101EB0, int arg1, bool arg2); // UDP: TODO
	DEFINE_MEMBER_FN(GetEffectiveMagickaCost, float, 0x00101C20, Character* caster); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(GetSex, char, 0x00351490, "80 79 1A 2B - 75 08 - 0F B6 41 38 - 83 E0 01 - C3 - 83 C8 FF");
	DEFINE_MEMBER_FN_EX(HasOverlays, bool, 0x00368C10, " 48 89 5C 24 20 - 57 - 48 83 EC 20 - 83 79 14 07");

	// Swaps a headPart of the same type as target with target
	DEFINE_MEMBER_FN_EX(ChangeHeadPart, void, 0x00365DE0, "48 89 54 24 10 - 55 56 57 41 54 41 55 41 56 41 57 - 48 8D 6C 24 D9 - 48 81 EC A0 00 00 00", BGSHeadPart * target);
	...
	DEFINE_MEMBER_FN_EX(UpdateNeck, void, 0x003608C0, "40 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 40 - 48 89 74 24 58 - 48 8B FA - 48 8B F1 - 48 8B DA", BSFaceGenNiNode * faceNode);

	// Computes RGB SkinTone from RGBA TintMask
	DEFINE_MEMBER_FN_EX(SetSkinFromTint, void, 0x00360670, "48 8B C4 - 41 56 - 48 83 EC 50 - 48 C7 40 C8 FE FF FF FF - 48 89 58 08", NiColorA * result, TintMask * tintMask, UInt32 compute, UInt32 unk1);
