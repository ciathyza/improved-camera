...
RelocAddr<_CreateRefHandleByREFR> CreateRefHandleByREFR(0x001322E0); // UDP: TODO
// D479D10F77326C177B3D5AE2C5738B0D39A1546A+5F
RelocAddrEx<_LookupREFRByHandle> LookupREFRByHandle(0x00132A90, "48 89 5C 24 10 - 48 89 6C 24 18 - 48 89 74 24 20 - 57 41 54 41 57 - 48 83 EC 20"); // Note: two signature matches, but the functions are identical
// B995A21984B048C2B4F61777E615FFFB2806F9B7+8C
RelocAddr<_LookupREFRObjectByHandle> LookupREFRObjectByHandle(0x00132BC0); // UDP: TODO
