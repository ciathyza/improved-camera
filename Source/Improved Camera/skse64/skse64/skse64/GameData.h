...
extern RelocAddrEx <UInt32*> g_gameTime; 
...
//	NiTArray<BGSAddonNode*>				addonNodes;		// D20
	...
	DEFINE_MEMBER_FN(LoadScripts, UInt32, 0x001715C0); // UDP: won't do (unlikely to be used by anything other than skse itself)
};
...
extern RelocPtrEx <DataHandler*> g_dataHandler; 
...
public:
	...
	DEFINE_MEMBER_FN_EX(EquipItem, void, 0x00637C70, "48 85 D2 - 0F 84 XXXX0000 - 57 - 48 83 EC 50 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 60 - 48 89 6C 24 70 - 48 89 74  24 78", Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool withEquipSound, bool preventUnequip, bool showMsg, void * unk);
	DEFINE_MEMBER_FN_EX(UnequipItem, bool, 0x00638380, "48 8B C4 - 57 41 56 41 57 - 48 83 EC 50 - 48 C7 40 B8 FE FF FF FF - 48 89 58 08 48 89 68 18", Actor * actor, TESForm * item, BaseExtraList * extraData, SInt32 count, BGSEquipSlot * equipSlot, bool unkFlag1, bool preventEquip, bool unkFlag2, bool unkFlag3, void * unk);
};


typedef BGSEquipSlot * (*_GetEitherHandSlot)();
extern RelocAddrEx<_GetEitherHandSlot> GetEitherHandSlot; 

typedef BGSEquipSlot * (*_GetRightHandSlot)();
extern RelocAddrEx<_GetRightHandSlot> GetRightHandSlot; 

typedef BGSEquipSlot * (*_GetLeftHandSlot)();
extern RelocAddrEx<_GetLeftHandSlot> GetLeftHandSlot; 

typedef UInt32(*_LookupActorValueByName)(const char * name);
extern RelocAddrEx<_LookupActorValueByName> LookupActorValueByName; 

typedef bool(*_HasLOS)(Actor* source, TESObjectREFR* target, UInt8 * unk1);
extern RelocAddrEx<_HasLOS> HasLOS; 

typedef UInt32(*_GetRelationshipIndex)(TESForm * form1, TESForm * form2);
extern RelocAddrEx<_GetRelationshipIndex> GetRelationshipIndex; 
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN_EX(GetFaceGenModelMapEntry, bool, 0x003D5180, "40 55 56 57 41 56 41 57 - 48 83 EC 40 - 48 C7 44 24 38 FE FF FF FF - 48 89 5C 24 70", const char * meshPath, BSFaceGenModelMap ** entry);
		DEFINE_MEMBER_FN_EX(SetFaceGenModelMapEntry, void, 0x003D4F70, "48 85 D2 - 0F 84 XXXX0000 - 55 56 57 - 48 83 EC 60 - 48 C7 44 24 48 FE FF FF FF", const char * meshPath, BSFaceGenModel * model);
	...
	DEFINE_MEMBER_FN_EX(RegenerateHead, void, 0x003D2C50, "48 8B C4 - 55 41 54 41 55 41 56 41 57 - 48 8D 68 B8 - 48 81 EC 20 01 00 00 - 48 C7 44 24 60 FE FF FF FF", BSFaceGenNiNode * headNode, BGSHeadPart * head, TESNPC * npc);
	DEFINE_MEMBER_FN_EX(ApplyMorph, void, 0x003D2570, "4D 85 C0 - 0F 84 XXXX0000 - 57 - 48 83 EC 50", BSFaceGenNiNode * faceGenNode, BGSHeadPart * headPart, BSFixedString * morphName, float relative);
};
...
extern RelocAddrEx<_ChangeActorHeadPart> ChangeActorHeadPart;


// Regenerates dynamic tints
typedef UInt32(*_UpdatePlayerTints)();
extern RelocAddrEx<_UpdatePlayerTints> UpdatePlayerTints; 

typedef BGSHeadPart ** (*_GetActorBaseOverlays)(TESNPC * npc);
extern RelocAddrEx<_GetActorBaseOverlays> GetActorBaseOverlays; 

typedef UInt32(*_GetNumActorBaseOverlays)(TESNPC * npc);
extern RelocAddrEx<_GetNumActorBaseOverlays> GetNumActorBaseOverlays; 

typedef bool(*_ApplyMasksToRenderTarget)(tArray<TintMask*> * tintMask, NiTexture * renderTarget);
extern RelocAddrEx<_ApplyMasksToRenderTarget> ApplyMasksToRenderTarget; 

typedef UInt32(*_UpdateModelSkin)(NiAVObject*, NiColorA**);
extern RelocAddr<_UpdateModelSkin> UpdateModelSkin; // UDP: TODO

typedef UInt32(*_UpdateModelHair)(NiAVObject*, NiColorA**);
extern RelocAddr<_UpdateModelHair> UpdateModelHair; // UDP: TODO

typedef UInt32(*_UpdateModelFace)(NiAVObject*);
extern RelocAddr<_UpdateModelFace> UpdateModelFace; // UDP: TODO

typedef void(*_UpdateHarvestModel)(TESObjectREFR*, NiAVObject*);
extern RelocAddr<_UpdateHarvestModel> UpdateHarvestModel; // UDP: TODO
...
public:
	...
	DEFINE_MEMBER_FN(CreateOffensiveEnchantment, EnchantmentItem *, 0x0059F2E0, tArray<MagicItem::EffectItem> * effectArray); // UDP: TODO
	DEFINE_MEMBER_FN(CreateDefensiveEnchantment, EnchantmentItem *, 0x0059F380, tArray<MagicItem::EffectItem> * effectArray); // UDP: TODO
	DEFINE_MEMBER_FN(CreatePoison, void, 0x0059F4D0, tArray<MagicItem::EffectItem> * effectArray, AlchemyItem ** poison); // UDP: TODO
	DEFINE_MEMBER_FN(CreatePotion, void, 0x0059F420, AlchemyItem ** potion, tArray<MagicItem::EffectItem> * effectArray); // UDP: TODO
	//DEFINE_MEMBER_FN(AddPersistentForm, void, 0x0068A0F0, TESForm *); // UDP: TODO
	DEFINE_MEMBER_FN(ScheduleForDeletion, void, 0x0059F8D0, TESForm *); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN(Save_Internal, bool, 0x00586FD0, int unk1, UInt32 unk2, const char * name); // UDP: TODO
	DEFINE_MEMBER_FN(Load_Internal, bool, 0x00587540, const char * name, int unk1, UInt32 unk2, UInt32 unk3); // UDP: TODO

	DEFINE_MEMBER_FN(SaveGame_HookTarget, void, 0x0057CEB0, UInt64 *unk0); // UDP: TODO
	DEFINE_MEMBER_FN(LoadGame_HookTarget, bool, 0x0057D390, UInt64 *unk0, UInt32 unk1, UInt32 unk2, void *unk3); // UDP: TODO

	DEFINE_MEMBER_FN(ProcessEvents_Internal, void, 0x00589C50); // UDP: TODO
	DEFINE_MEMBER_FN(DeleteSavegame, void, 0x00586F60, const char * saveName, UInt32 unk1); // UDP: TODO
};
