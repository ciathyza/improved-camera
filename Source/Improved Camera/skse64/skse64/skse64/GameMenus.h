...
public:
	...
	DEFINE_MEMBER_FN(InitMovie_internal, void, 0x00ECD6B0, GFxMovieView* view); // UDP: TODO
	DEFINE_MEMBER_FN(NextFrame_internal, void, 0x00ECD5E0, UInt32 arg0, UInt32 arg1); // UDP: TODO
	DEFINE_MEMBER_FN(ProcessMessage_internal, UInt32, 0x00ECD590, UIMessage* message); // UDP: TODO
	DEFINE_MEMBER_FN(dtor, void, 0x00ECD530); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN(LoadSliders, void *, 0x008B6010, UInt64 unk1, UInt8 unk2); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN(dtor, void, 0x008855F0); // UDP: TODO
};
...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(SetData, void, 0x0086F320, GFxValue* target); // UDP: TODO
...
//	DEFINE_MEMBER_FN(AddMessage, void, 0x004503E0, UIMessage * msg);	// old 1.1 implementation
	...
	DEFINE_MEMBER_FN_EX(AddMessage, void, 0x001654C0, "40 56 57 41 56 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 58 - 48 89 6C 24 60 - 49 8B F1", StringCache::Ref * strData, UInt32 msgID, void * objData);
	DEFINE_MEMBER_FN_EX(CreateUIMessageData, IUIMessageData *, 0x00EC2F10, "48 89 5C 24 20 - 56 57 41 56 - 48 83 EC 20 - 33 F6", const BSFixedString &type);

	static UIManager *	GetSingleton(void)
	{
		// CB598A8812CFF3959F94DC8F8371BA876F68AE34+67
		static RelocPtrEx<UIManager*> g_UIManager(0x533FC8, "48 8B 0D XXXXXXXX -  45 8D 41 03 - 48 83 C4 28", 3, true); // 1EE7A70 Note: two signatures match, but both to same var.
		return *g_UIManager;
	}
	...
	DEFINE_MEMBER_FN(ProcessEventQueue_HookTarget, void, 0x00EC2E30); // UDP: TODO
};
...
public:
	...
	static UIStringHolder *	GetSingleton(void)
	{
		...
		static RelocPtrEx<UIStringHolder *> g_UIStringHolder(0x22D554, "48 8B 04 C1 - 48 8B 70 08 - 48 8B 05 XXXXXXXX - 48 8B 98 58 02 00 00", 0xB, true); // 1EE7A78 Note: two signatures matches, both will resolve the var
...
public:
	...
	static Inventory3DManager * GetSingleton(void)
	{
		...
		static RelocPtr<Inventory3DManager*> g_inventory3DManager(0x02F4E180); // UDP: TODO
	...
	DEFINE_MEMBER_FN(UpdateItem3D, void, 0x00887B60, InventoryEntryData * objDesc); // UDP: TODO
	DEFINE_MEMBER_FN(UpdateMagic3D, void, 0x00887B90, TESForm * form, UInt32 unk1); // UDP: TODO
	DEFINE_MEMBER_FN(Clear3D, void, 0x00887F00); // UDP: TODO
	DEFINE_MEMBER_FN(Render, UInt32, 0x00887940); // UDP: TODO
...
private:
	...
	DEFINE_MEMBER_FN_EX(IsMenuOpen, bool, 0x00EBDE90, "48 8B C4 - 41 56 - 48 83 EC 40 - 48 C7 40 D8 FE FF FF FF - 48 89 58 10", BSFixedString * menuName);
	DEFINE_MEMBER_FN_EX(Register_internal, void, 0x00EBF700, "48 8B C4 - 53 56 57 - 48 83 EC 50 - 48 C7 40 C8 FE FF FF FF - 48 8B D9", const char * name, CreatorFunc creator);
...
public:
	...
	static MenuManager * GetSingleton(void)
	{
		...
		static RelocPtrEx<MenuManager *> g_menuManager(0x8E4F76, "48 8B 05 XXXXXXXX - 38 98 C1 01 00 00 - 75 XX", 3, true); // 1EE5B20
