...
extern RelocAddr<_WorldPtToScreenPt3_Internal> WorldPtToScreenPt3_Internal; // UDP: TODO
...
public:
	...
	DEFINE_MEMBER_FN(DeepCopy, NiStream *, 0x00C526E0, NiObject ** result); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(UpdateNode, void, 0x00C56890, "40 53 - 48 83 EC 20 - 48 8B 01 - 45 33 C0 - 48 8B D9 - FF 90 60 01 00 00", ControllerUpdateContext * ctx);
};
...
public:
	...
	DEFINE_MEMBER_FN(ctor, void, 0x003D4260); // UDP: TODO
	DEFINE_MEMBER_FN(CopyFrom, void, 0x003D4340, BSFaceGenModel * other); // UDP: TODO
	DEFINE_MEMBER_FN(SetModelData, bool, 0x003D49B0, const char * meshPath, void * unk1, UInt8 unk2); // UDP: TODO
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x003D4820, BSFixedString * morphName, TESModelTri * triModel, NiAVObject ** headNode, float relative, UInt8 unk1); // UDP: TODO
};
...
public:
	...
	DEFINE_MEMBER_FN(ApplyMorph, UInt8, 0x003D7A50, const char ** morphName, NiAVObject * faceTrishape, float relative, UInt8 unk2); // UDP: TODO
};
