...
//	void			** _vtbl;		// 000
	...
	DEFINE_MEMBER_FN(ctor, PlayerControls *, 0x00704B60); // UDP: TODO
};
...
public:
	...
	static InputStringHolder *	GetSingleton(void)
	{
		...
		static RelocPtrEx<InputStringHolder*> g_inputStringHolder(0x7091C6, "48 8B 05 XXXXXXXX - 48 8B 48 40 - 48 39 4D D0", 3, true); // 2F4C250
