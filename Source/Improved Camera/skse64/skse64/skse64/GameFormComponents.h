...
public:
	...
	DEFINE_MEMBER_FN_EX(Get, void, 0x00190670, "48 89 5C 24 08 - 48 89 74 24 10 - 57 - 48 83 EC 30 - 48 8B 05 XXXXXXXX", BSString * out, TESForm * parent, UInt32 fieldType);
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(UpdateWeightData, void, 0x001C6390, "40 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 40 - 48 89 74 24 50 - 48 8B F9 - 48 8D 0D XXXXXXXX");
	DEFINE_MEMBER_FN_EX(DeleteThis, void, 0x001C6290, "40 53 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 8B D9 - E8 XXXXXXXX - 90 - 48 8D 8B C0 13 00 00");
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(SetEquipFlag, void, 0x0067E5A0, "48 8B 41 08 - 48 85 C0 - 74 06 - 08 90 11 03 00 00", UInt8 flags);
	DEFINE_MEMBER_FN_EX(UpdateEquipment, void, 0x00650FE0, "40 55 56 57 41 54 41 55 41 56 41 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 78 - 48 8B F2 - 4C 8B F1", Actor * actor);
	// FBB0A4AE04B0C1C63470C26B004079D7D9B20D0B+8B
	DEFINE_MEMBER_FN_EX(SetDataFlag, void, 0x0065CA70, "48 8B 41 10 - 48 85 C0 - 74 08 - F3 0F 11 88 E4 01 00 00", float flag); // Sets a number on the 0x10 object. SE: The parameter flag was actually a float (xmm1)
...
public:
	...
	DEFINE_MEMBER_FN_EX(GetSkillData, UInt32, 0x006E6320, "4C 8B 11 - 8D 42 FA - 48 8D 48 01 - 8B D0 - 48 8D 0C 48", UInt32 actorValue, float * level, float * points, float * pointsMax, UInt32 * unk6);
	DEFINE_MEMBER_FN_EX(IncrementLegendary, UInt32, 0x006E6810, "48 89 5C 24 08 - 57 - 48 83 EC 20 - 48 8B 01 - 83 C2 FA", UInt32 actorValue);
	DEFINE_MEMBER_FN_EX(SetLevel, void, 0x006E67B0, " 48 89 5C 24 08 - 57 - 48 83 EC 20 - 48 8B F9 - 8B DA - 48 8B 0D XXXXXXXX - E8 XXXXXXXX - 0F B7 C0", UInt32 level);
};
