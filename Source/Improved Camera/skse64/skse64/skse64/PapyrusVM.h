...
public:
	...
	DEFINE_MEMBER_FN_EX(Destroy, void, 0x0124E610, "40 53 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 8B D9 - 33 D2 - E8 XXXXXXXX");
	DEFINE_MEMBER_FN_EX(GetVariable, SInt32, 0x0124F980, "48 89 5C 24 08 - 48 89 74 24 10 - 48 89 7C 24 18 - 4C 89 74 24 20 - 41 57 - 48 83 EC 20 - 44 8B 05 XXXXXXXX - 48 8B F9", BSFixedString * name);
	DEFINE_MEMBER_FN_EX(GetFunction, IFunction*, 0x01253B30, "40 53 - 44 8B 51 24 - 4C 8B DA - 44 8B 49 20 - 41 8B C2", const char * fnName); // Two matches for the signature, but the two functions are 100% identical
};
...
//	void						** _vtbl;								// 0000
	...
	DEFINE_MEMBER_FN(UnregisterFromSleep_Internal, void, 0x009249D0, UInt64 handle); // UDP: TODO
	DEFINE_MEMBER_FN(RevertGlobalData_Internal, bool, 0x0092DCD0); // UDP: TODO
	// E79F47684196468F785E6950402DBDAA5A668FAA+110
	DEFINE_MEMBER_FN(SaveRegSleepEventHandles_Internal, bool, 0x0092ED40, void * handleReaderWriter, void * saveStorageWrapper); // UDP: TODO
	// ECCDB3740458A9BB07FA958498C66F04CE14F94C+1E6
	DEFINE_MEMBER_FN(LoadRegSleepEventHandles_Internal, bool, 0x0092FF70, void * handleReaderWriter, void * loadStorageWrapper); // UDP: TODO

	// 00011FEFBFDA69F253C84165B45736A4F0AF02B8+204
	DEFINE_MEMBER_FN(QueueDelayFunctor_Internal, bool, 0x009254B0, void** pFunctor); // // UDP: TODO
...
extern RelocPtrEx<SkyrimVM*> g_skyrimVM;
...
public:
	...
	struct Output
	{
		...
		DEFINE_MEMBER_FN_EX(Resize, bool, 0x00920550, "41 56 - 48 83 EC 40 - 48 C7 44 24 30 FE FF FF FF - 48 89 5C 24 50 - 48 89 6C 24 58 - 48 89 74 24 60 - 48 89 7C 24 68 - 8B F2", UInt32 len);
	};
