...
extern RelocAddr<_CreateRefHandleByREFR> CreateRefHandleByREFR; // UDP: TODO

// Note: May set refHandle to 0
typedef bool (* _LookupREFRByHandle)(UInt32 * refHandle, TESObjectREFR ** refrOut);
extern RelocAddrEx<_LookupREFRByHandle> LookupREFRByHandle; 

typedef bool (* _LookupREFRObjectByHandle)(UInt32 * refHandle, BSHandleRefObject ** refrOut);
extern RelocAddr<_LookupREFRObjectByHandle> LookupREFRObjectByHandle; // UDP: TODO

extern RelocPtr<UInt32> g_invalidRefHandle; // UDP: TODO
...
extern RelocAddr<_MoveRefrToPosition> MoveRefrToPosition; // UDP: TODO
...
extern RelocAddr<_PlaceAtMe_Native> PlaceAtMe_Native; // UDP: TODO
...
extern RelocAddr<_AddItem_Native> AddItem_Native; // UDP: TODO
...
public:
	...
	DEFINE_MEMBER_FN_EX(GetBaseScale, float, 0x0028CE50, "48 83 EC 38 - 0F B7 81 90 00 00 00 - 48 8B 49 40");
	DEFINE_MEMBER_FN_EX(IsOffLimits, bool, 0x0029A520, "48 89 5C 24 08 - 48 89 74 24 10 - 57 - 48 83 EC 20 - 48 8B F9 - 32 DB");
	// E2B825B476DC5CFBC69E194AA76CB0C049AC78E3+137
	DEFINE_MEMBER_FN_EX_JUMP(GetWeight, float, 0x002A71E0, "48 8B 49 40 - E9 XXXXXXXX", 5, "40 53 - 48 83 EC 30 - 0F 29 74 24 20 - 48 8B D9 - F3 0F 10 35 XXXXXXXX - 48 85 C9");
	DEFINE_MEMBER_FN_EX(GetReferenceName, const char *, 0x002963E0, "40 53 55 56 57 41 54 41 55 41 56 41 57 - 48 83 EC 58 - 48 C7 44 24 20 FE FF FF FF - 0F 29 74 24 40 - 0F 29 7C 24 30");
	DEFINE_MEMBER_FN_EX(GetWorldspace, TESWorldSpace*, 0x00299940, "48 83 EC 28 - 48 8B 41 60 - 48 85 C0 - 75 0E - 48 8B 01");
};
...
public:
	...
	DEFINE_MEMBER_FN_EX(QueueNiNodeUpdate, void, 0x00693300, "40 55 56 57 - 48 83 EC 30 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 50 - 0F B6 DA - 48 8B F1", bool updateWeight);
	DEFINE_MEMBER_FN_EX(HasPerk, bool, 0x005FA020, "48 83 EC 28 - 48 8B 81 F0 00 00 00 - 48 85 C0 - 74 16", BGSPerk * perk);
	DEFINE_MEMBER_FN_EX(GetLevel, UInt16, 0x005D64D0, "48 8B 49 40 - 48 83 C1 30 - E9 XXXXXXXX");
	DEFINE_MEMBER_FN_EX(SetRace, void, 0x00607870, "48 85 D2 - 0F 84 XXXX0000 - 41 56 - 48 83 EC 40 - 48 C7 44 24 30 FE FF FF FF - 48 89 5C 24 50", TESRace*, bool isPlayer);
	DEFINE_MEMBER_FN_EX(UpdateWeaponAbility, void, 0x006315C0, "48 85 D2 - 0F 84 XXXX0000 - 48 89 6C 24 18 - 56 57 41 56 - 48 83 EC 30", TESForm*, BaseExtraList * extraData, bool bLeftHand);
	DEFINE_MEMBER_FN_EX(UpdateArmorAbility, void, 0x00631550, "48 89 5C 24 10 - 56 - 48 83 EC 20 - 80 7A 1A 1A", TESForm*, BaseExtraList * extraData);
	DEFINE_MEMBER_FN_EX(IsHostileToActor, bool, 0x005E8030, "48 89 5C 24 10 - 48 89 74 24 18 - 57 - 48 83 EC 20 - 48 8B F2 - 48 8B D9 40 - 32 FF", Actor * actor);
	DEFINE_MEMBER_FN_EX(ResetAI, void, 0x005DB500, "48 8B C4 - 56 57 41 56 - 48 83 EC 60 - 48 C7 40 D8 FE FF FF FF - 48 89 58 10 - 48 89 68 18 41 - 0F B6 D8", UInt32 unk1, UInt32 unk2);
...
public:
	...
	DEFINE_MEMBER_FN_EX(GetNumTints, UInt32, 0x006B5640, "44 8B 81 20 0B 00 00 - 33 C0 - 45 85 C0", UInt32 tintType);
	DEFINE_MEMBER_FN_EX(GetTintMask, TintMask *, 0x006B5490, "48 89 5C 24 08 - 48 89 74 24 10 - 48 89 7C 24 18 - 44 8B 99 20 0B 00 00", UInt32 tintType, UInt32 index);
	DEFINE_MEMBER_FN_EX(GetDamage, float, 0x00693240, "40 57 - 48 83 EC 20 - 48 8B F9 - 48 85 D2 - 74 XX - 48 89 5C 24 30 - 48 8B 1A", InventoryEntryData * pForm);
	DEFINE_MEMBER_FN_EX(GetArmorValue, float, 0x00692EC0, "40 57 - 48 83 EC 50 - 48 C7 44 24 20 FE FF FF FF - 48 89 5C 24 68 - 48 8B FA", InventoryEntryData * pForm);
};
