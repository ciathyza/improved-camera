...
public:
	...
	DEFINE_MEMBER_FN_EX(GetOffset, UInt32, 0x0125BD40, "44 8B 51 50 - 45 33 C0 - 32 C0 - 4C 8B C9 - 45 85 D2", VMState * state);
	// 20AE20213D7A9C7AB3491192BCCB2467282AE266+62
	DEFINE_MEMBER_FN_EX(Get, VMValue *, 0x0125BDA0, "40 53 - 48 83 EC 30 - 44 89 4C 24 58 - 48 8D 44 24 40", VMState * state, UInt32 idx, UInt32 offset); // Note: two matches but the 2 functions are 100% identical
};
